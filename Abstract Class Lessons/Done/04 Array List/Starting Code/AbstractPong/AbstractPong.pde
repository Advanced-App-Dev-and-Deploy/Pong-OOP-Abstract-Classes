...
void setup()
{
  ...
  rHexLeft = new Rectangle(appWidth*1/40, appHeight*1/8, rectWidth, rectHeight);
  rHexRight = new Rectangle(appWidth*38/40, appHeight*1/8, rectWidth, rectHeight);
}//End setup
//
void draw() {
  background(0);
  //Arithmetic
  cHex.paddleBounceLeft( rHexLeft.xGetter(), rHexLeft.yGetter(), rHexLeft.wGetter(), rHexLeft.hGetter() );
  cHex.paddleBounceRight( rHexRight.xGetter(), rHexRight.yGetter(), rHexRight.hGetter() );
